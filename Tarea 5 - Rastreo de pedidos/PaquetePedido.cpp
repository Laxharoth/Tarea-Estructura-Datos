...
PaquetePedido::PaquetePedido( string nombre_remitente, string nomre_destinatario, string estado_envío, string destino_direccion ):
    numero_pedido(++next_numero_pedido), 
    nombre_remitente(nombre_remitente),nomre_destinatario(nomre_destinatario), 
    estado_envío(estado_envío),destino_direccion(destino_direccion){}
